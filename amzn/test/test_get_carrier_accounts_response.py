...
from amazon_shipping.models.get_carrier_accounts_response import GetCarrierAccountsResponse  # noqa: E501
...
class TestGetCarrierAccountsResponse(unittest.TestCase):
    ...
    def testGetCarrierAccountsResponse(self):
        ...
        # model = amazon_shipping.models.get_carrier_accounts_response.GetCarrierAccountsResponse()  # noqa: E501
        pass
