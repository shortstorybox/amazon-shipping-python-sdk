...
from amazon_shipping.models.get_rates_response import GetRatesResponse  # noqa: E501
...
class TestGetRatesResponse(unittest.TestCase):
    ...
    def testGetRatesResponse(self):
        ...
        # model = amazon_shipping.models.get_rates_response.GetRatesResponse()  # noqa: E501
        pass
