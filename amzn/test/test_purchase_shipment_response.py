...
from amazon_shipping.models.purchase_shipment_response import PurchaseShipmentResponse  # noqa: E501
...
class TestPurchaseShipmentResponse(unittest.TestCase):
    ...
    def testPurchaseShipmentResponse(self):
        ...
        # model = amazon_shipping.models.purchase_shipment_response.PurchaseShipmentResponse()  # noqa: E501
        pass
