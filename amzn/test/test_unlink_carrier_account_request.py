...
from amazon_shipping.models.unlink_carrier_account_request import UnlinkCarrierAccountRequest  # noqa: E501
...
class TestUnlinkCarrierAccountRequest(unittest.TestCase):
    ...
    def testUnlinkCarrierAccountRequest(self):
        ...
        # model = amazon_shipping.models.unlink_carrier_account_request.UnlinkCarrierAccountRequest()  # noqa: E501
        pass
