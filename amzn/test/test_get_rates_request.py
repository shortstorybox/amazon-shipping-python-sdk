...
from amazon_shipping.models.get_rates_request import GetRatesRequest  # noqa: E501
...
class TestGetRatesRequest(unittest.TestCase):
    ...
    def testGetRatesRequest(self):
        ...
        # model = amazon_shipping.models.get_rates_request.GetRatesRequest()  # noqa: E501
        pass
