...
from amazon_shipping.models.unlink_carrier_account_response import UnlinkCarrierAccountResponse  # noqa: E501
...
class TestUnlinkCarrierAccountResponse(unittest.TestCase):
    ...
    def testUnlinkCarrierAccountResponse(self):
        ...
        # model = amazon_shipping.models.unlink_carrier_account_response.UnlinkCarrierAccountResponse()  # noqa: E501
        pass
